...
> **회사 PC 다음 작업 체크포인트:** 1927 원고와 표지는 실서비스에 공개됐지만, 운영자가 표지에 추가 수정할 부분이 있다고 명시했다. 현재 이미지를 최종 승인본으로 간주하지 않는다. 회사에서 운영자의 구체적 피드백을 받은 뒤 1927 한 장을 먼저 완성하고, 그 승인값을 코파 후속 연도의 기준으로 확장한다. 다음 대회 대량 제작은 1927 표지 승인 뒤 시작한다.
