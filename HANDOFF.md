...
- 한글 표기는 영어권 중개형을 자동으로 따르지 않는다. 국립국어원 외래어 표기법·용례, 원언어의 실제 음가, 자국식 성명 순서, 당사자·기관의 공식 명칭을 함께 대조한다. 본문에는 확인된 원언어형을 우선하고 국내 통용형은 첫 등장 설명 또는 `tags`·`keywords`에 검색 별칭으로 보존한다. 인물과 그 이름을 딴 상·경기장처럼 명칭의 성립 언어가 다르면 문맥별 공식 명칭을 각각 판단한다.
