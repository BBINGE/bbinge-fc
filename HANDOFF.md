...
- Google Search Console 도메인 속성 인증과 sitemap 제출을 완료했다. NAVER Search Advisor는 공통 head에 소유권 확인 태그를 추가해 인증을 진행 중이다. GA4와 AdSense는 실제 콘텐츠를 더 축적한 뒤 진행한다.
...
- Google Search Console 도메인 소유권 인증 및 sitemap 제출 성공(2026-08-13). NAVER Search Advisor 소유권 인증 진행 후 sitemap·RSS 등록 예정. AdSense 심사 신청과 GA4는 콘텐츠 분량 확보 후 진행한다.
