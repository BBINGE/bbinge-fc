...
- 새 브랜드 설명 페이지 `/about/logo/`는 P(박성호)와 BB(삥이)의 의미, 결합 심볼, 브랜드 색상 `#191F28`·`#3182F6`·`#F2F6FE`와 사용 이유를 설명한다.
- 로고 심볼은 P와 BB를 완전히 해독시키기보다 한 덩어리로 기억되는 형태를 우선하며, 타이포 로고 `삥이FC`와 함께 사용한다.
