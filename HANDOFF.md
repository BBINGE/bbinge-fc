...
- **[최우선] 블로그 에디터 시스템** — `EDITOR_SPEC.md` v1.0 확정(2026-07-28). 사이트의 존재 이유는 운영자만 쓸 수 있는 글이며, 게임·GOAT는 애드센스 유입 기반일 뿐. 네이버 스마트에디터 원 수준의 위지윅(오픈소스 기반)+R2 이미지 업로드+유튜브 임베드+카테고리 데이터화+자동저장·예약발행. 이 프로젝트의 메인 과제이므로 다음 세션의 중심 작업으로 착수. 착수 전 §8 결정사항(글 저장 방식·로그인) 확인
