...
형 프란시스코와 구분해 ‘레스메스 2세’<span class="foreign-note" lang="es">(Lesmes II)</span>로 불린 라파엘 레스메스<span class="foreign-note" lang="es">(Rafael Lesmes Bobed; 스페인 수비수, 1926–2012)</span>는 전진보다 위치를 먼저 생각한 왼쪽 수비수였다. 상대 공격수가 받을 길을 미리 닫고, 공을 되찾은 뒤에는 무리한 전개보다 공격진이 다시 자리를 잡을 시간을 벌었다.

그는 1956년 스타드 드 랭스, 1957년 피오렌티나, 1958년 AC 밀란을 상대한 첫 세 차례 유러피언컵 결승에 모두 선발 출전했다. 산타마리아가 오기 전의 수비와 그가 합류한 뒤의 수비를 모두 경험했다는 점에서, 이 긴 시대를 연결하는 왼쪽 수비수로 골랐다.<a class="cite" href="#source-3" aria-label="출처 3">[3]</a>
...
나시오날에서 이미 우루과이 대표 수비수로 완성된 뒤 1957년 마드리드에 온 호세 산타마리아<span class="foreign-note" lang="es-UY">(José Emilio Santamaría Iglesias; 우루과이·스페인 수비수, 1929–2026)</span>는 수비선의 기준점을 바꿨다. 강한 대인 방어와 제공권뿐 아니라, 어느 순간 전진하고 어느 순간 물러날지를 판단하는 능력이 앞선 선수였다.

첫 두 번의 유러피언컵 우승에는 없었지만, 합류 첫 시즌부터 AC 밀란을 꺾은 세 번째 우승의 중앙을 맡았다. 이후 네 번째와 다섯 번째 우승, 첫 인터컨티넨탈컵을 지나 1966년 ‘예예 마드리드’의 여섯 번째 유럽 제패까지 연결했다. 그래서 이 명단에서 그는 한 시기의 수비수이면서 두 세대를 잇는 축이다.<a class="cite" href="#source-4" aria-label="출처 4">[4]</a>
...
마르코스 알론소 이마스<span class="foreign-note" lang="es">(Marcos Alonso Imaz; 스페인 수비수, 1933–2012)</span>는 오른쪽 풀백과 중앙 수비를 오간 과감한 수비수였다. 1956년 초대 유러피언컵 결승에서 레알 마드리드가 스타드 드 랭스에 2-3으로 뒤지던 순간, 수비수인 그가 직접 동점골을 넣었다. 리알의 결승골이 나오기 전에 패배의 방향을 되돌린 골이었다.

다섯 번의 유러피언컵 우승을 모두 선수단에서 경험했고, 결승마다 상대의 가장 직접적인 공격을 받아냈다. 레스메스가 위치와 균형을 대표한다면 마르키토스는 충돌과 전진을 대표한다. 서로 다른 성향의 두 풀백 사이에 산타마리아를 둔 이유다.<a class="cite" href="#source-5" aria-label="출처 5">[5]</a>
...
상징성만 놓고 보면 미겔 무뇨스가 먼저 떠오른다. 하지만 이 명단은 공로 훈장이 아니라, 왕조의 가장 강한 순간을 한 팀으로 조립하는 선택이다. 후안 산티스테반<span class="foreign-note" lang="es">(Juan Santisteban Troyano; 스페인 미드필더, 1936–2023)</span>은 공을 받은 뒤 방향을 바꾸는 기술과 전진 패스로 사라가의 노동을 공격으로 환원했다.

1957–58시즌부터 사라가와 함께 중원을 맡았고, 첫 네 차례 유러피언컵 우승 선수단에 포함됐다. 절정기에 입은 근육 부상이 제대로 치료되지 않으면서 1960년 결승에는 뛰지 못했다. 짧아진 전성기 때문에 통산 규모는 작지만, 이 팀에 필요한 것은 또 한 명의 상징이 아니라 사라가와 다른 방식으로 공을 다루는 미드필더라고 판단했다.<a class="cite" href="#source-7" aria-label="출처 7">[7]</a>
...
‘금빛 화살’<span class="foreign-note" lang="es">(La Saeta Rubia)</span>이라는 별명은 속도만을 설명하지 않는다. 디스테파노는 센터포워드 자리에서 출발해 중원으로 내려오고, 공을 빼앗은 뒤 다시 페널티 지역까지 올라갔다. 득점자·플레이메이커·압박의 시작점을 한 사람에게서 분리하기 어려웠다. 그래서 이 명단에서도 특정 포지션보다 프리 롤로 적었다.

1956년부터 1960년까지 다섯 차례 유러피언컵 결승에서 모두 득점했고, 1960년 아인트라흐트 프랑크푸르트전에서는 해트트릭을 기록했다. 레알 마드리드 공식전 396경기 308골, 발롱도르 2회와 유일한 슈퍼 발롱도르. 이 팀의 다른 열 자리는 디스테파노가 가장 넓게 움직일 수 있도록 맞춰진다.<a class="cite" href="#source-8" aria-label="출처 8">[8]</a>
...
푸슈카시 페렌츠<span class="foreign-note" lang="hu">(Puskás Ferenc; 헝가리식 성명 순서의 공격수, 1927–2006)</span>는 ‘매직 머저르’의 주장으로 이미 한 시대를 끝낸 뒤 서른한 살에 마드리드에 왔다. 긴 공백과 체중을 이유로 의심받았지만, 왼발의 힘과 슈팅 각도를 만드는 기술은 사라지지 않았다. 디스테파노가 공간을 넓히면 푸슈카시는 그 공간을 골로 닫았다.

1960년 프랑크푸르트와의 유러피언컵 결승에서 네 골, 1962년 벤피카와의 결승에서 해트트릭을 넣었다. 두 차례 유러피언컵 결승에서 해트트릭 이상을 기록한 골 결정력은 이 커스텀 팀에 반드시 필요한 종결 능력이다. 레알 마드리드 공식 기록은 262경기 242골이다.<a class="cite" href="#source-9" aria-label="출처 9">[9]</a>
...
레몽 코파<span class="foreign-note" lang="fr">(Raymond Kopaszewski; 프랑스 공격수, 1931–2017)</span>는 스타드 드 랭스의 에이스로 1956년 초대 유러피언컵 결승에서 레알 마드리드를 상대했다. 결승 직전 이미 이적이 결정돼 있었고, 다음 시즌부터는 자신을 꺾은 팀의 오른쪽에서 뛰었다. 좁은 공간의 드리블과 짧은 패스, 중앙으로 접어드는 판단이 뛰어났다.

마드리드에서 보낸 세 시즌마다 유러피언컵을 우승했고, 1958년에는 발롱도르를 받았다. 푸슈카시와의 공존은 길지 않았지만 이 글은 단일 시즌 선발표가 아니다. 헨토가 직선적인 폭을 만든다면 코파는 오른쪽에서 안으로 들어오며 다른 리듬을 만든다.<a class="cite" href="#source-11" aria-label="출처 11">[11]</a>
...
엑토르 리알<span class="foreign-note" lang="es-AR">(José Héctor Rial Laguía; 아르헨티나·스페인 공격수, 1928–1991)</span>은 골문 앞에만 머무는 9번이 아니었다. 기술과 시야, 긴 패스로 왼쪽의 헨토를 살렸고, 직접 슈팅과 헤더로 공격을 끝낼 수도 있었다. 디스테파노와 플레이메이킹 역할이 겹치면서도 서로 위치를 바꿔 수비의 기준점을 흐렸다.

1956년 랭스와의 결승에서 결승골을 넣었고, 1958년 밀란과의 결승에서도 득점했다. 다섯 차례 유러피언컵 우승을 모두 경험한 공격수이며, 레알 마드리드 공식 기록은 169경기 83골이다. 푸슈카시가 가장 강한 마무리라면 리알은 이 팀의 공격을 한 문장에서 다음 문장으로 이어주는 접속사다.<a class="cite" href="#source-12" aria-label="출처 12">[12]</a>
