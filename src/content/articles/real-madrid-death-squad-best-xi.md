...
1956년부터 1960년까지 다섯 차례 유러피언컵 결승에서 빠짐없이 득점했고, 1960년 아인트라흐트 프랑크푸르트전에서는 해트트릭을 기록했다. 레알 마드리드 공식전 396경기 308골, 발롱도르 2회와 유일한 슈퍼 발롱도르라는 이력도 압도적이다. 그러나 숫자보다 중요한 것은 다른 선수의 장점까지 끌어냈다는 점이다. 이 팀의 나머지 열 자리는 디스테파노가 가장 넓게 움직이고, 그 움직임이 동료의 공간으로 이어지도록 맞춰진다.<a class="cite" href="#source-8" aria-label="출처 8">[8]</a>
