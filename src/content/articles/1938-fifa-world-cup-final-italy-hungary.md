---
title: '1938 FIFA 월드컵 결승전 H/L: 이탈리아 4-2 헝가리'
description: '지노 콜라우시와 실비오 피올라의 멀티골, 헝가리의 두 차례 추격과 이탈리아의 사상 첫 월드컵 2연패까지. 1938 FIFA 월드컵 결승전을 FIFA 기록 영상으로 다시 본다.'
category: 'fifa-world-cup'
tags: ['1938 FIFA 월드컵', '이탈리아 헝가리', '월드컵 결승전', '실비오 피올라', '지노 콜라우시', '축구 하이라이트']
pubDate: 2026-08-14T21:30:00+09:00
coverImage: '/images/highlights/1938-world-cup-final-cover.png'
coverImageAlt: '1938 FIFA 월드컵 결승전 이탈리아 4대2 헝가리 하이라이트 표지'
...
1938년 6월 19일, 파리 외곽 콜롱브의 스타드 올랭피크 이브 뒤 마누아르<span class="foreign-note" lang="fr">(Stade Olympique Yves-du-Manoir)</span>. 이탈리아는 4년 전 로마에서 들어 올린 월드컵을 지키기 위해 마지막 경기에 들어섰다. 상대는 대회 세 경기에서 13골을 넣고 결승까지 올라온 헝가리였다.
...
<section class="highlight-scene">
  ...
  <div class="highlight-clip-grid"><figure><video class="highlight-clip" muted loop playsinline controls preload="none" data-autoplay-on-view aria-label="티트코시 팔의 1938 월드컵 결승전 동점골"><source src="/media/highlights/1938-world-cup-final/titkos-8.mp4?v=2" type="video/mp4" /></video><figcaption>문전에서 흘러나온 공을 티트코시가 왼발로 때려 2분 만에 동점을 만들었다.</figcaption></figure></div>
...
<section class="highlight-scene">
  ...
  <p>전반 35분에는 주장 주세페 메아차<span class="foreign-note" lang="it">(Giuseppe Meazza; 이탈리아 주장·인사이드 포워드)</span>가 오른쪽에서 공격을 이어받아 골문 앞을 바라봤다. 중앙으로 보낸 공을 콜라우시가 마무리하면서 점수는 3-1이 됐다. 선제골을 넣은 콜라우시가 멀티골을 완성했고, 이탈리아는 전반에만 세 골을 쌓았다.</p>
...
<section class="highlight-scene">
  ...
  <div class="highlight-clip-grid"><figure><video class="highlight-clip" muted loop playsinline controls preload="none" data-autoplay-on-view aria-label="샤로시 죄르지의 1938 월드컵 결승전 추격골"><source src="/media/highlights/1938-world-cup-final/sarosi-70.mp4?v=2" type="video/mp4" /></video><figcaption>헝가리의 빠른 전개를 샤로시 죄르지가 마무리해 점수를 3-2로 좁혔다.</figcaption></figure></div>
  <p>후반 25분, 헝가리가 다시 속도를 냈다. 오른쪽으로 전개된 공격이 골문 앞으로 낮게 이어졌고, 주장 샤로시 죄르지<span class="foreign-note" lang="hu">(Sárosi György; 헝가리식 성명 순서의 주장·공격수)</span>가 달려들어 마무리했다. 3-2. 전반에 벌어진 두 골 차가 다시 한 골로 줄었다.</p>
...
<section class="highlight-scene">
  ...
  <div class="highlight-clip-grid"><figure><video class="highlight-clip" muted loop playsinline controls preload="none" data-autoplay-on-view aria-label="실비오 피올라의 1938 월드컵 결승전 두 번째 골"><source src="/media/highlights/1938-world-cup-final/piola-82.mp4?v=2" type="video/mp4" /></video><figcaption>피올라가 오른발로 자신의 두 번째 골을 넣어 결승전을 4-2로 닫았다.</figcaption></figure></div>
...
<div class="source-notes">
  <h2>영상과 기록 출처</h2>
  <ol>
    <li>경기 영상: 국제축구연맹 FIFA 공개 기록 영상 <a href="https://www.youtube.com/watch?v=dbJIqjny2Jk">“1938 WORLD CUP FINAL: Italy 4-2 Hungary”</a>. 여섯 득점은 장면 순서대로 묶어 로컬 MP4로 보존했다.</li>
    <li><a href="https://inside.fifa.com/tournaments/mens/worldcup/1938france/news/dominant-azzurri-retain-their-crown-2866627">“Dominant Azzurri retain their crown”</a>, FIFA. 양 팀의 대회 흐름과 콜라우시·피올라의 멀티골.</li>
