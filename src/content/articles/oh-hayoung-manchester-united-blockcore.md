...
축구 유니폼이 경기장에서만 입는 옷이 아니게 된 지금, 같은 셔츠도 무엇과 겹쳐 입고 어떤 신발을 고르느냐에 따라 전혀 다른 분위기가 된다. 오하영의 코디에서 눈에 들어온 세 가지 활용법을 살펴보자. 그냥 `예쁘다`로 넘기기에는 꽤 영리한 조합이 많다.
...
<h2 id="look-01">1. 베컴 레트로 유니폼과 봄 스타일</h2>
...
<h2 id="look-02">2. 청바지와 함께 입는 놈코어룩</h2>
...
<h2 id="look-03">3. 셸 파카와 맨유의 검정·빨강</h2>
...
<section class="wardrobe-guide" aria-labelledby="wardrobe-guide-title">
  ...
  <h2 id="wardrobe-guide-title">내 옷장에는 어느 맨유가 맞을까</h2>
