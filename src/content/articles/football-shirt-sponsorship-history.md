...
coverImageAlt: 'SSC 나폴리 유니폼의 MSC 스폰서 로고를 드러내며 웃고 있는 두아 리파'
coverImageCaption: '한때 경기 규정이 금지했던 셔츠 광고는 이제 팝스타의 휴양지 사진까지 이동한다. 두아 리파가 입은 SSC 나폴리 2023-24 홈 셔츠에는 MSC 로고가 선명하다. Photo via @dualipa / Instagram.'
...
<section class="review-frame" aria-labelledby="review-frame-title">
  ...
  <div class="review-frame__grid">
    <article><strong>질문</strong><p>기업 표식은 어떻게 선수의 몸에서 팬의 일상복으로 이동했는가.</p></article>
    <article><strong>자료</strong><p>구단·협회·박물관 공식 기록, 장비 규정, 스포츠사·복식사 연구, 실제 착장 이미지.</p></article>
    <article><strong>선정 기준</strong><p>표식의 허용, 방송 노출, 복제품 판매, 문화적 재유통 가운데 한 단계 이상을 직접 증명하는 자료.</p></article>
    <article><strong>한계</strong><p>‘세계 최초’ 주장은 국가와 리그마다 기준이 다르다. 독일·영국의 제도화 사례를 중심으로 비교한다.</p></article>
  </div>
</section>

## 유니폼은 원래 광고가 없었던 것이 아니라, 다른 것을 광고했다
...
그 경계가 중요하다. 관중석의 간판은 경기장에 남지만 셔츠는 선수와 함께 움직인다. 카메라가 공을 좇으면 로고도 화면 중앙으로 이동한다. 골을 넣은 선수가 클로즈업되면 기업명은 감정이 가장 커지는 순간에 노출된다. 셔츠 앞면은 고정된 광고판이 아니라 **경기의 서사를 따라다니는 매체**가 될 수 있었다.

따라서 유니폼 스폰서의 역사는 빈 천에 로고 하나를 인쇄한 디자인사가 아니다. 협회가 선수의 몸을 어떤 공간으로 규정했는지, 방송사가 그 몸을 화면에 내보낼 것인지, 팬이 같은 옷을 상품으로 받아들일 것인지가 차례로 협상된 역사다.
...
<div class="case-compare" role="table" aria-label="브라운슈바이크와 케터링 타운 셔츠 광고 사례 비교">
  ...
  <div role="row"><strong>브라운슈바이크<br />1973</strong><p>광고 문구·표식</p><p>기업 로고를 프로팀 문장으로 채택</p><p>독일 프로축구의 선례</p></div>
  <div role="row"><strong>케터링 타운<br />1976</strong><p>스폰서 명칭</p><p>`KETTERING T`를 구단명으로 주장</p><p>1977년 잉글랜드 허용</p></div>
</div>

## 허용만으로는 부족했다: 카메라가 광고의 값을 정했다

셔츠에 기업명을 새길 수 있게 되었다고 곧바로 큰 광고 상품이 된 것은 아니다. 광고주는 경기장 관중만이 아니라 화면의 관중을 원했다. 문제는 영국의 방송사들이 1970년대 말과 1980년대 초 스폰서가 붙은 셔츠의 방영을 거부했다는 점이다. 중계가 예정된 날 구단은 로고가 없는 셔츠로 갈아입어야 했다.<sup><a href="#source-3">[3]</a></sup>
...
<section class="exposure-chain" aria-labelledby="exposure-chain-title">
  ...
  <div>
    <article><b>01</b><strong>선수의 몸</strong><p>경기의 모든 동작에 표식이 붙는다.</p></article>
    <i aria-hidden="true">→</i>
    <article><b>02</b><strong>중계 화면</strong><p>클로즈업과 재방송이 노출을 복제한다.</p></article>
    <i aria-hidden="true">→</i>
    <article><b>03</b><strong>레플리카</strong><p>시청자는 같은 표식이 든 셔츠를 구매한다.</p></article>
    <i aria-hidden="true">→</i>
    <article><b>04</b><strong>일상 이미지</strong><p>셀럽 착장과 팬의 사진이 다시 배포한다.</p></article>
  </div>
</section>
...
숫자는 상업화가 무제한이라는 뜻이 아니다. 오히려 축구 조직이 팀의 식별성과 대회 표식, 제조사와 복수 스폰서의 이해를 한 벌 안에서 배분하고 있음을 뜻한다. 광고는 더 이상 예외가 아니다. 너무 커지지 않도록 측정해야 하는 정상적인 구성 요소가 되었다.
...
이 현상을 단순히 향수라고 부르면 한 단계가 빠진다. 팬이 그리워하는 것은 기업 자체라기보다 로고가 붙어 있던 시기의 팀이다. 그러나 그 기억은 로고를 제거하면 정확히 복원되지 않는다. 스폰서가 당시 셔츠의 색과 비례, 선수의 몸, 중계 화면 속 장면에 결합했기 때문이다. 광고가 오랫동안 반복되면 상업 표식도 구단 기억의 색인처럼 기능한다.
...
두 이미지는 화질이 달라서 한쪽이 다른 쪽보다 덜 중요한 것이 아니다. 두아 리파의 사진은 기업 로고가 얼마나 매력적인 이미지 안에 자연스럽게 들어갈 수 있는지를 증명한다. 말루 보르지스의 영상 캡처는 그 이미지가 플랫폼의 반응과 모방, 재게시를 통해 어떻게 움직이는지 보여준다. 잘 찍힌 화보와 팬의 셀피, 짧은 영상은 역사 사진의 장식용 후손이 아니다. 오늘날 광고가 이동하는 경로 자체다.
...
이 관계는 언제나 평화롭지 않다. 로고의 업종과 디자인이 구단의 이미지에 맞지 않는다는 반발도 생기고, 규제 때문에 같은 시즌의 셔츠가 대회마다 달라지기도 한다. 광고가 정체성에 녹아들 수 있다는 사실과, 광고가 여전히 임대된 상업 공간이라는 사실은 동시에 참이다. 바로 그 긴장이 스폰서가 사라진 레트로 복각판을 어딘가 허전하게 만들고, 반대로 낯선 새 로고를 처음에는 이물질처럼 보이게 한다.
...
<div class="shirt-closing">
  <p>기업은 선수에게 광고를 입히기 위해 구단에 돈을 냈다.</p>
  <p>팬은 그 광고를 입기 위해 다시 구단에 돈을 냈다.</p>
</div>

처음에는 기업이 축구의 몸을 빌렸다. 이제는 우리가 그 몸의 복제품을 산다. 다만 거리에서 그것을 ‘광고판’이라고 부르는 사람은 드물다. 우리는 대개 팀의 이름, 선수의 번호, 어느 계절의 기억을 먼저 말한다.

광고가 보이지 않게 된 것이 아니다. 너무 오래, 너무 정확하게 축구의 일부로 보이는 법을 배운 것이다.
