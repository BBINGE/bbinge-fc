...
이 명단은 한 시즌 안에서 고른 열한 명이다. 그래서 이름값의 총합보다 그해 실제로 맞물린 조합에 가깝다. 뒤에는 서른여섯의 폴크스와 열아홉의 애스턴이 함께 서 있고, 중원에는 공을 되찾는 사람과 공을 흘려보내는 사람과 경기를 끌고 다니는 사람이 각각 한 명씩 있다. 앞의 셋은 모두 스무 살 안팎이거나 스물둘이었다. 참사로 한 세대를 잃은 구단이 다음 세대를 다시 길러내 유럽으로 돌아갔다는 사실이 명단의 나이에 그대로 남아 있다.
...
그가 무엇을 했는지는 상대 오른쪽 수비수의 위치로 설명된다. 애스턴은 결승 내내 벤피카의 오른쪽을 혼자 갈랐고, 그 바깥쪽 압박이 중앙의 에우제비우에게 공이 편하게 가지 못하게 만들었다. 대표팀 경력도 없고 트로피 이후의 경력도 길지 않았던 선수가 구단 역사상 가장 중요한 90분에서 최고의 선수였다는 기록은, 이 명단이 그해의 조합으로 만들어졌다는 사실을 가장 분명하게 보여준다.
...
참고로 그가 빅 이어를 확정 짓는 골을 터뜨리던 날은 18세에서 19세로 넘어가던 키드의 ‘생일’이었다. 이건 기록으로 남아 있다. 키드는 1949년 5월 29일에 태어났고, 결승은 1968년 5월 29일에 열렸다. 그는 열아홉 번째 생일에 유러피언컵 결승에 선발로 나서 골을 넣었다.
