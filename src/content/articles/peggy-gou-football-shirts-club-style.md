...
페기 구<span class="foreign-note" lang="en">(Kim Min-ji; 대한민국 DJ·프로듀서, 1991-)</span>의 사진에서는 축구 셔츠가 응원석보다 도시의 보도와 클럽 앞에서 더 자주 보인다. 빨강과 흰색의 마틴 로즈<span class="foreign-note" lang="en">(Martine Rose; 영국 패션 디자이너, 1980-)</span> 풋볼 셔츠에는 검정 사이클링 쇼츠와 에르메스 버킨백이 붙고, 파란 저지에는 테일러드 팬츠와 샤넬백이 이어진다. 서로 멀어 보이는 옷들이지만, 사진 속에서는 오래 같은 옷장에 있던 물건처럼 자연스럽다.
