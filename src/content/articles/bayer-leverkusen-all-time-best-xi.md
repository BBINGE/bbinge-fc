...
완성 편집물에 포함된 선수 사진은 인물을 식별하고 해당 선수의 경기사적 의미를 비평·교육·정보 전달하기 위한 문맥에서 제한적으로 사용한다. 원사진을 독립 감상물이나 다운로드 자료로 재배포하지 않으며 기록·해설·선정 논리·새로운 정보 위계와 시각 구성을 결합했다. 편집적 창작성과 원사진의 권리는 다른 층위이므로 자체 기여는 밝히되 원사진의 권리까지 소유한다고 주장하지 않는다. 구단·리그 문장은 식별과 설명의 문맥에서 사용하며 공식 후원이나 제휴를 뜻하지 않는다.
