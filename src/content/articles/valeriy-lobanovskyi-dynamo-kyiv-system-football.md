...
개인의 자유는 조직이 없는 상태가 아니다. 오히려 동료가 어디에 있을지 믿을 수 있을 때 더 과감해진다. 그리하여 블로힌의 속도는 고립된 질주가 아니라 팀이 열어 둔 공간을 찢었고, 벨라노우의 폭발력은 압박과 전환의 끝에서 반복됐다. **시스템은 인간을 지우지 않았다. 천재가 더 자주, 더 안정적으로, 더 오래 나타나게 했다.**
...
<div class="vl-reading">
  ...
  <article><span>WITHOUT THE BALL</span><strong>공 가까운 곳을 함께 닫는다</strong><p>개인의 추격이 아니라 여러 선수가 같은 순간 압박해 상대의 다음 패스를 제한한다.</p></article>
...
<div class="vl-return">
  ...
  <strong>낡은 체계를 복원한 것이 아니라<br />같은 원리로 새 속도를 만들었다</strong>
...
그는 과학을 축구 바깥의 권위로 들여오지 않았다. 경기를 더 잘 이해하고 훈련을 더 정교하게 만들며, 선수들의 관계를 반복 가능한 수준으로 끌어올리는 내부 언어로 사용했다. 과학이 감독의 직관을 몰아낸 것이 아니라, 직관이 맞았는지 틀렸는지 다시 물을 수 있게 했다. 이 질문하는 체계가 로바노우스키의 가장 깊은 유산이다.

<section class="vl-video" aria-label="발레리 로바노우스키 장례와 추모 영상">
  <div class="vl-video__copy"><span>KYIV · MAY 2002</span><h3>로바노우스키, 전설과의 작별</h3><p>2002년 키이우가 로바노우스키를 떠나보낸 장면이다. 전술의 증거가 아니라, 그 체계를 함께 살아낸 도시와 사람들이 한 감독을 어떻게 기억했는지 보여주는 기록이다.</p><a href="https://www.youtube.com/watch?v=HZi-VNKBOgs" target="_blank" rel="noopener noreferrer">YouTube에서 원문 보기</a></div>
