---
title: "루이스 수아레스(Luis Suárez Miramontes) 프로필·스탯·역대 등번호: 그란데 인테르의 건축가"
description: "바르셀로나의 공격형 미드필더에서 그란데 인테르의 후방 설계자로 변신한 루이스 수아레스 미라몬테스. 1960 발롱도르, 유로 1964 우승, 클럽·국대 기록과 등번호를 함께 읽는다."
branch: legends
index: spain
year: 1935
subject: "루이스 수아레스"
originalTitle: "Luis Suárez Miramontes"
keywords: ["루이스 수아레스 미라몬테스", "Luis Suárez Miramontes", "루이스 수아레스 프로필", "루이스 수아레스 스탯", "루이스 수아레스 등번호", "그란데 인테르", "건축가", "1960 발롱도르", "UEFA 유로 1964", "스페인 역대 미드필더"]
tags: ["스페인", "FC 바르셀로나", "인테르", "그란데 인테르", "발롱도르", "중앙 미드필더"]
relatedGroup: "luis-suarez-grande-inter"
pubDate: 2026-08-23T17:00:00+09:00
coverImage: "/images/archive/legends/luis-suarez/luis-suarez-cover.png"
coverImageAlt: "1960년 발롱도르 트로피를 바라보는 루이스 수아레스 미라몬테스"
...
<div class="record-abstract">
  <span>편집자 평가</span>
  <p>루이스 수아레스는 공격형 미드필더와 후방 플레이메이커를 한 경력 안에서 최고 수준으로 수행했다. 바르셀로나에서는 드리블과 득점으로 전진했고, 인테르에서는 수비선 앞에서 경기의 속도와 방향을 정했다. 산드로 마촐라가 문전으로 침투하고 자친토 파케티가 왼쪽을 질주할 때, 그 움직임이 시작될 위치로 공을 보내는 선수가 수아레스였다. 1960년 발롱도르와 UEFA 유로 1964 우승은 이 설계자가 스페인 축구사에서 차비 에르난데스·안드레스 이니에스타와 함께 가장 먼저 논해야 할 미드필더라는 판단을 뒷받침한다.</p>
</div>

<div class="legend-reel" data-legend-reel style="--reel-count: 6">
  <div class="legend-reel-head"><span>루이스 수아레스 플레이</span><strong>건축가의 시야와 마무리를 보여주는 여섯 장면</strong><small data-reel-count>1 / 6</small></div>
  <video muted playsinline preload="metadata" aria-label="루이스 수아레스 미라몬테스 플레이 영상 연속 재생"></video>
  <div class="legend-reel-foot"><p data-reel-caption>마촐라와 공을 주고받은 뒤 빈 공간으로 들어간다. 패스와 이동이 하나의 2대1 공격을 만든다.</p><div class="legend-reel-progress" aria-hidden="true"><i></i><i></i><i></i><i></i><i></i><i></i></div></div>
  <ol hidden data-reel-playlist>
    <li data-src="/videos/archive/legends/luis-suarez/01-one-two-with-mazzola.mp4">마촐라와 공을 주고받은 뒤 빈 공간으로 들어간다. 패스와 이동이 하나의 2대1 공격을 만든다.</li>
    <li data-src="/videos/archive/legends/luis-suarez/02-control-the-tempo.mp4">서두르지 않고 상대와 동료의 간격을 읽는다. 수아레스의 완급 조절이 다음 공격의 속도를 결정한다.</li>
    <li data-src="/videos/archive/legends/luis-suarez/03-dribble-two-defenders.mp4">두 수비수가 좁혀 와도 첫 방향을 숨긴 채 침착하게 빠져나가 전진로를 연다.</li>
    <li data-src="/videos/archive/legends/luis-suarez/04-first-touch-and-goal.mp4">퍼스트 터치로 공을 슈팅 가능한 위치에 놓고, 수비가 정렬되기 전에 득점을 끝낸다.</li>
    <li data-src="/videos/archive/legends/luis-suarez/05-combination-and-finish.mp4">동료를 벽처럼 활용한 뒤 다시 공을 받아 직접 마무리한다. 설계와 실행이 한 선수에게 이어진다.</li>
    <li data-src="/videos/archive/legends/luis-suarez/06-through-ball-finish.mp4">스루 패스의 길을 먼저 읽고 수비 뒤로 출발한다. 좋은 패스를 받아 득점하는 움직임도 공격수의 능력이다.</li>
  </ol>
</div>
...
2. 엘레니오 에레라<span class="foreign-note" lang="es-AR">(Helenio Herrera Gavilán; 아르헨티나 태생의 축구 감독, 1910-1997)</span>와의 관계는 단순한 총애가 아니었다. 에레라가 수비 조직과 빠른 전환을 요구했을 때 수아레스는 탈취한 공을 공격으로 바꾸는 첫 판단을 맡았다. 단단한 수비 뒤에 그가 있었기 때문에 인테르의 축구는 걷어내고 버티는 데서 끝나지 않았다.

3. 산드로 마촐라<span class="foreign-note" lang="it">(Sandro Mazzola; 이탈리아 공격형 미드필더, 1942-)</span>와의 분업은 그란데 인테르의 중심이었다. 수아레스가 아래에서 공을 배급하면 마촐라는 수비 사이로 침투했고, 마리오 코르소는 왼발로 마지막 패스를 보탰다. 파케티의 긴 오버래핑까지 더해지면서 한 번의 긴 패스가 곧 여러 선수의 동시 출발 신호가 됐다.
...
<div class="record-facts record-facts-spain">
  ...
  <dl><dt>별명</dt><dd>건축가 · 루이시토</dd></dl><dl><dt>대표 국적</dt><dd>스페인</dd></dl>
</div>

본명은 **루이스 수아레스 미라몬테스**<span class="foreign-note" lang="es">(Luis Suárez Miramontes; 스페인 축구선수, 1935-2023)</span>다. 우루과이 공격수 루이스 수아레스와 구분하기 위해 원어 등록명과 본명을 제목에 함께 썼다. 갈리시아의 라코루냐에서 태어나 데포르티보의 유소년 체계로 들어갔고, 열여덟 살에 고향 팀의 1군 경기에 데뷔했다.
...
<figure><img src="/images/archive/legends/luis-suarez/luis-suarez-barcelona.jpg" alt="FC 바르셀로나 유니폼을 입고 앉아 있는 루이스 수아레스" width="966" height="729" loading="lazy" /><figcaption>바르셀로나 시절의 수아레스. 전진 드리블과 득점력을 갖춘 공격형 미드필더로 1960년 발롱도르를 받았다.</figcaption></figure>
...
<figure><img src="/images/archive/legends/luis-suarez/luis-suarez-inter.png" alt="인테르 유니폼을 입은 루이스 수아레스와 엘레니오 에레라, 마리오 코르소" width="966" height="966" loading="lazy" /><figcaption>왼쪽의 수아레스, 가운데 에레라 감독, 오른쪽의 마리오 코르소. 수아레스는 에레라의 수비 조직을 공격으로 전환하는 설계자였다.</figcaption></figure>
...
<div class="number-history-table">
  <table><thead><tr><th>소속팀</th><th>확인 기간</th><th>등번호</th></tr></thead><tbody>
    <tr><td>데포르티보 라코루냐</td><td>1953-54 시즌 경기 자료</td><td><strong>10</strong></td></tr>
    <tr><td>CD 에스파냐 인두스트리알</td><td>1954-55 시즌 경기 자료</td><td>자료 제한</td></tr>
    <tr><td>FC 바르셀로나</td><td>1954-1961년 경기 자료</td><td><strong>10</strong> · 8</td></tr>
    <tr><td>FC 인테르나치오날레 밀라노</td><td>1961-1970년 경기 자료</td><td><strong>10</strong> · 8</td></tr>
    <tr><td>UC 삼프도리아</td><td>1970-1973년 경기 자료</td><td><strong>10</strong></td></tr>
  </tbody></table>
</div>
...
<p class="record-note">수아레스의 시대에는 시즌 고정 번호보다 선발 위치에 따른 1-11번 배정이 일반적이었다. 표는 당시 경기 사진·대회 명단과 확인 가능한 등번호 자료에서 반복되는 번호를 정리한 것이며, 현대의 시즌별 등록 번호와 같은 의미는 아니다.</p>

## 대표 우승 경력

<div class="career-honours">
  <section><strong>라리가<small lang="es">La Liga</small></strong><p><b>우승:</b> 1958-59, 1959-60</p></section>
  <section><strong>코파 델 헤네랄리시모<small lang="es">Copa del Generalísimo · 현재의 코파 델 레이</small></strong><p><b>우승:</b> 1956-57, 1958-59</p></section>
  <section><strong>인터시티스 페어스컵<small lang="en">Inter-Cities Fairs Cup</small></strong><p><b>우승:</b> 1955-58, 1958-60</p></section>
...
<ul class="career-awards">
  ...
  <li><strong>UEFA 유로 대회 베스트 11</strong><span>1964년</span></li>
  <li><strong>월드 사커 전 세계 베스트 11</strong><small>영국 축구 전문지 선정</small><span>1963년 · 1964년 · 1965년</span></li>
  <li><strong>골든풋</strong><small>은퇴한 축구 전설 부문</small><span>2008년</span></li>
</ul>
