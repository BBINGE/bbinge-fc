...
1. 레그로탈리에의 최고점은 유벤투스 이적 뒤가 아니라 이적 직전의 치에보였다. 2002-03 세리에 A에서 30경기 4골을 기록했고, 당시 이탈리아 대표팀은 치에보에서 뛰던 그를 불러 데뷔 기회를 줬다. 명문 구단의 이름이 선수의 위상을 만든 것이 아니라 작은 구단에서의 한 시즌이 명문 구단과 아주리를 동시에 열었다.
