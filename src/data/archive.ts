...
export const archiveBranches: ArchiveBranch[] = [
  ...
  },
  {
    ...
    indexes: [
      ['european-cup', '유러피언컵'], ['uefa-champions-league', 'UEFA 챔피언스 리그'], ['uefa-cup-winners-cup', '유러피언 컵위너스컵'], ['uefa-cup', 'UEFA컵'], ['uefa-europa-league', 'UEFA 유로파 리그'], ['uefa-europa-conference-league', 'UEFA 컨퍼런스 리그'], ['copa-libertadores', '코파 리베르타도레스'], ['intercontinental-cup', '인터콘티넨털컵'],
    ].map(([slug, label]) => ({ slug, label })),
  },
  {
    id: 'national-team',
