...
const europeanCup1957Stories: ReadingRouteStory[] = [
  {
    id: '1957-58-european-cup',
    href: '/archive/club/european-cup/1957-58-european-cup/',
    index: '01',
    label: '대회관 · 참가팀과 본선',
    title: '스물네 구단은 어떻게 4강까지 좁혀졌나',
    description: '동전으로 끝난 베를린 재경기와 베오그라드의 3-3, 예선부터 8강까지 읽기',
    image: '/images/archive/1957-58-european-cup/cover.png',
    theme: 'european-cup',
  },
  {
    id: '1957-58-european-cup-semifinals',
    href: '/archive/club/european-cup/1957-58-european-cup-semifinals/',
    index: '02',
    label: '대회관 · 4강',
    title: '결승행 두 자리는 누가 가져갔나',
    description: '디스테파노의 세 골과 뮌헨 석 달 뒤의 올드 트래퍼드, 4강 네 경기 읽기',
    image: '/images/archive/1957-58-european-cup-semifinals/cover.png',
    theme: 'european-cup',
  },
  {
    id: '1957-58-european-cup-final-real-madrid-milan',
    href: '/highlights/european-cup/1957-58-european-cup-final-real-madrid-milan/',
    index: '03',
    label: 'H/L · 결승전',
    title: '아토미움 아래의 결승은 어떻게 연장까지 갔나',
    description: '두 번 앞선 밀란과 두 번 따라붙은 레알, 헨토의 107분을 장면별 영상으로 보기',
