...
- 새 구단 18곳(도르트문트·스포라·디나모 부쿠레슈티·갈라타사라이·슬로반·CWKS·맨유·니스·포르투·아틀레티코 데 빌바오·CDNA·레인저스·그라스호퍼·노르셰핑·라피트 JC·츠르베나 즈베즈다·혼베드·피오렌티나)을 `historical-clubs.json`에 추가했다. 국기만 `1956-57`로 대조했고 `crests`는 빈 배열이다. 대진 카드 36칸 가운데 로고는 3칸뿐이며 나머지는 승인 규칙대로 흰 칸을 비워 둔다.
- 기존 구단의 1956-57 확장: 안데를레흐트 `anderlecht-1933.svg`(1933-1959)와 레알 `real-madrid-1941.svg`(1941-1997)는 도안 기간 안이라 문장까지 추가했다. 라피트·오르후스의 운영자 제공 문장은 `다른 시즌 자동 확장 금지`에 따라 국기만 추가했다.
- 구단명은 당시 명칭이다. `라피트 JC`(로다 JC 아님), `AC 피오렌티나`(ACF 아님), `아틀레티코 데 빌바오`(1941-1972년 명칭). 운영자 도판의 후대 명칭은 캡션에서 교정한다.
- 새 국기: `bg-1948.svg`(1948-1967 불가리아), `ro-1952.svg`(1952-1965 루마니아), `lu.svg`, `tr.svg`. 모두 Wikimedia Commons 원본 무변형.
- 운영자 도판에는 1956-57 구단 로고가 들어 있지만 도판 크롭은 금지다. 운영자가 독립 로고 파일을 제공하면 해당 구단 `crests`에 `selection: operator-supplied`로 연결한다.
