...
- 생성 시각: 2026. 9. 21. 0시 3분 0초 (KST)
- 이 파일을 만든 시점의 커밋: `d556611` · 2026-09-20 23:58 · 축쿼드(발렌시아): 앙글로마 카드의 숫자가 카르보니 것임을 밝히고 바로잡는다
- 작업 트리: 커밋 안 된 변경 2건
...
2026-09-20  5f0208b  교정: 표지 캡션과 description의 상투구를 걷는다
2026-09-20  dd848ff  교정: 팝업관과 카테고리 문구의 상투구를 걷는다
```
