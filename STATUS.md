...
- 생성 시각: 2026. 9. 20. 0시 25분 23초 (KST)
- 이 파일을 만든 시점의 커밋: `28be12a` · 2026-09-20 00:15 · 축쿼드: 선수 소제목을 이름 먼저로 통일하고 긴 문단을 나눈다
- 작업 트리: 커밋 안 된 변경 5건
...
```
2026-09-20  28be12a  축쿼드: 선수 소제목을 이름 먼저로 통일하고 긴 문단을 나눈다
2026-09-19  ab4e504  데이터: 오늘 밤 해축 자동 갱신
2026-09-20  22c8622  디자인: 삥이 아카이브에도 이미지와 글 사이 바닥 여백을 맞춘다
2026-09-19  ef539da  디자인: 이미지와 글이 붙어 그림자가 글자를 덮던 여백을 전역으로 올린다
2026-09-19  2613475  문서: 글 페이지에 목차 UI가 없다는 사실을 인수인계에 맞춘다
2026-09-19  f91d465  문서: 축쿼드 열 편의 문단 길이 실측값을 인수인계에 바로잡는다
2026-09-19  1ebee62  수리(축쿼드): 독일 세 편의 소제목이 글자로 나오던 줄 구성을 끊는다
2026-09-19  7c55f43  데이터: 오늘 밤 해축 자동 갱신
2026-09-19  591c27f  데이터: 오늘 밤 해축 자동 갱신
2026-09-18  c19e4a8  데이터: 오늘 밤 해축 자동 갱신
2026-09-19  dd3c5b8  문서: 손톱 금지와 인용문 규격을 디자인 명세에 올린다
2026-09-18  1681506  문서: 작은 색막대 제거와 인용문 순서 확정을 인수인계에 남긴다
```
