...
- 생성 시각: 2026. 9. 21. 14시 56분 37초 (KST)
- 이 파일을 만든 시점의 커밋: `6a0cd38` · 2026-09-21 14:48 · 축쿼드: 열한 편에 남은 제작 경위 문장을 걷는다
- 작업 트리: 커밋 안 된 변경 2건
...
```
2026-09-21  6a0cd38  축쿼드: 열한 편에 남은 제작 경위 문장을 걷는다
2026-09-21  cfe6992  축쿼드(세비야): 출처 목록에 적은 제작 경위를 걷는다
2026-09-21  8db882d  축쿼드: 세비야 FC 역대 베스트 11을 올린다
2026-09-21  3b51ba8  축떡(페널티킥): 모바일에서 골대를 지나치던 공을 경기장 비례로 움직인다
2026-09-21  f227f46  디자인: 화면 글자 하한을 12px로 올리고 빌드에서 막는다
2026-09-21  d49c86b  문서: 축쿼드 해명 문장 교체 경위를 인수인계에 남긴다
2026-09-21  9f375df  축쿼드(발렌시아): 같은 해명 두 곳을 구단의 조건으로 바꾼다
2026-09-21  0f265dd  축쿼드: 형식을 해명하던 열 곳을 구단별 원고로 바꾼다
2026-09-20  a27fde9  데이터: 오늘 밤 해축 자동 갱신
2026-09-20  dee7194  데이터: 오늘 밤 해축 자동 갱신
2026-09-20  a4372f6  데이터: 오늘 밤 해축 자동 갱신
2026-09-21  3fb39c1  교정(발렌시아): 정정 주석이 위 문단을 파고들던 것을 카드 밑으로 내린다
```
