...
- 생성 시각: 2026. 9. 20. 20시 32분 44초 (KST)
- 이 파일을 만든 시점의 커밋: `9510171` · 2026-09-20 20:26 · 교정: 문단을 꺾어 닫던 `A가 아니라 B` 158곳을 서술로 푼다
- 작업 트리: 커밋 안 된 변경 21건
...
2026-09-19  b03f11a  데이터: 오늘 밤 해축 자동 갱신
2026-09-20  0d964c0  교정: 네덜란드어 인명의 전치사를 성에 붙여 쓴다
```
