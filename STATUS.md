...
- 생성 시각: 2026. 9. 20. 23시 7분 39초 (KST)
- 이 파일을 만든 시점의 커밋: `ff04c34` · 2026-09-20 23:01 · 축쿼드(레알): 선수 절의 밀도를 올리고 세 자리의 블록을 갈라 놓는다
- 작업 트리: 커밋 안 된 변경 5건
...
- `spain` 역대 베스트 11 4편: athletic-club, atletico-madrid, fc-barcelona, real-madrid
